...
class PacienteRepository:
    ...
    def obtener_perfil_paciente(self, id_usuario_paciente: int) -> dict:
        """
    ...
    def actualizar_perfil_paciente(self, id_usuario_paciente: int, data: PerfilPacienteUpdate) -> dict:
        """
